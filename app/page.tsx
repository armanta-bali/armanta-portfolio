...
import { ArrowUpRight, Terminal, MapPin, Coffee, Sparkles} from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description: "Welcome to my portfolio. I'm a Frontend Developer specializing in React, Next.js, and modern web technologies. Available for freelance and full-time opportunities.",
};
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 px-4 pt-16 md:pt-20 py-8 md:p-8 lg:p-12">
      <div className="mt-20 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[minmax(160px,auto)] md:auto-rows-[minmax(180px,auto)]">
        ...
        <BentoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between bg-linear-to-br from-zinc-900 to-zinc-950">
          <div>
            ...
            <p className="text-sm xs:text-base md:text-lg text-zinc-400 max-w-lg leading-relaxed">
              A Frontend Developer focused on building fast, accessible, and visually stunning web interfaces using React & Next.js.
            </p>
          </div>
          ...
          <div className="flex flex-col xs:flex-row items-start xs:items-center gap-4 mt-6 md:mt-8">
            ...
            <Link 
              href="/contact" 
              className="flex items-center gap-2 border border-zinc-700 text-zinc-300 px-4 xs:px-5 py-2.5 rounded-full font-medium hover:bg-zinc-800 transition-colors text-sm md:text-base w-full xs:w-auto justify-center"
        ...
        <BentoCard className="md:col-span-1" delay={0.1}>
          <Terminal className="w-6 h-6 md:w-8 md:h-8 text-purple-400 mb-3 md:mb-4" />
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                {project.liveUrl ? (
                  ...
                  >
                    View Live Demo <ArrowUpRight className="w-4 h-4 group-hover/card:translate-x-1 group-hover/card:-translate-y-1 transition-transform" />
                  </Link>
                ) : (
                  <Link 
        ...
        <BentoCard className="md:col-span-3 bg-linear-to-r from-zinc-900 via-zinc-900 to-blue-950/30" delay={0.5}>
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h3 className="text-base md:text-lg font-semibold">When I'm not coding...</h3>
              <p className="text-zinc-400 text-sm md:text-base">
                I'm exploring single-origin coffee, reading sci-fi books, or playing indie games.
              </p>
            </div>
          </div>
        </BentoCard>
